package com.cut2it.playerviewlibrary01.avcommunication;
...
public class AVCommunication {
  ...
  //  private RangeSeekBar mRangeSeekbar;
    ...
    public AVCommunication(Context context) {
        mContext = context;
        this.controller = new PlayerControlView(context, null, 0);
    ...
    public SimpleExoPlayer makeStream(PlayerView playerView, String videoUrl) {
        makeHandler();
